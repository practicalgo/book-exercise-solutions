...
import (
	...
	"github.com/practicalgo/book-exercise-solutions/chap4/exercise4/middleware"
)
...
func validateConfig(c httpConfig, outputFile string) error {
	...
	if len(outputFile) != 0 && c.numRequests > 1 {
		return ErrInvalidHTTPCommand
	}
...
http: <options> server`
	...
	err = validateConfig(c, outputFile)
	if err != nil {
